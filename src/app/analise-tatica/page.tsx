...
const article = {
  ...
  sections: [
    {
      heading: "Cenário do Confronto: Rivalidade em Alta e Briga no Topo",
      paragraphs: [
        ...
        "Do outro lado, o São Paulo, sob o comando de seu técnico (Luis Zubeldía), busca se consolidar no G-4 e provar que pode brigar pelo título. O Tricolor vem de uma sequência positiva e vê no clássico a oportunidade perfeita para dar um recado aos rivais.",
        "**Detalhes da Partida:**",
        "*   **Jogo:** Palmeiras x São Paulo",
        "*   **Competição:** Brasileirão Série A 2025 – Rodada (a ser confirmada, geralmente entre a 5ª e 8ª rodada em maio)",
    ...
    },
    {
      ...
      paragraphs: [
        "O Palmeiras de Abel Ferreira é uma máquina de jogar futebol, conhecida pela intensidade, organização tática e versatilidade. Podemos esperar um time postado no seu tradicional 4-3-3 ou variações como o 3-5-2, dependendo da estratégia para o clássico.",
        "**Pontos Fortes:**",
        "*   **Defesa Sólida:** Comandada por Gustavo Gómez e Murilo, a zaga alviverde é um paredão. A compactação defensiva e a disciplina tática dos laterais e volantes são cruciais.",
        "*   **Transição Rápida:** O Palmeiras é letal nos contra-ataques, aproveitando a velocidade de seus pontas (como Dudu, Rony, Endrick – ou quem estiver em melhor forma) e a inteligência de Raphael Veiga na armação.",
        "*   **Bola Parada:** Tanto defensiva quanto ofensivamente, o Palmeiras é muito forte.",
        "*   **Força Mental:** O time de Abel é conhecido por não se abalar em momentos de pressão.",
        "**Provável Escalação (base):** Weverton; Mayke (Marcos Rocha), Gustavo Gómez, Murilo e Piquerez; Zé Rafael, Gabriel Menino (Richard Ríos) e Raphael Veiga; Dudu (Bruno Rodrigues/Lázaro), Endrick (Flaco López) e Rony.",
    ...
    },
    {
      ...
      paragraphs: [
        "O São Paulo de Luis Zubeldía provavelmente virá a campo buscando neutralizar os pontos fortes do rival e explorar suas próprias qualidades, possivelmente em um 4-2-3-1 ou 4-4-2.",
        "**Pontos Fortes:**",
        "*   **Qualidade no Meio-Campo:** Com jogadores como Alisson, Pablo Maia, Rodrigo Nestor e Luciano, o Tricolor tem capacidade de controlar o jogo.",
        "*   **Força Pelas Laterais:** Seus laterais (Rafinha/Igor Vinícius, Welington) participam ativamente da construção ofensiva.",
        "*   **Poder de Finalização:** Com Calleri no comando de ataque, o São Paulo tem um finalizador nato.",
        "**Provável Escalação (base):** Rafael; Rafinha (Igor Vinícius), Arboleda, Ferraresi (Diego Costa) e Welington; Pablo Maia, Alisson e Luciano (Galoppo/James Rodríguez); Wellington Rato (Erick), Calleri e Lucas Moura (Ferreirinha).",
        "*(Sempre verificar as notícias sobre lesões, suspensões e opções do treinador antes de confirmar essa base)*",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "*   **Duelos Individuais:** Confrontos dos pontas contra laterais, ou centroavantes contra zagueiros.",
